...
public class MailClient extends JFrame {
    ...
    private JTextField txtUsername, txtReceiver, txtMessage;
    ...
    public MailClient() {
        ...
        bottomPanel.add(new JLabel("Người nhận:"));
        bottomPanel.add(txtReceiver);
        bottomPanel.add(new JLabel("Nội dung:"));
